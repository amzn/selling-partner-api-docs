...
|**Query**|**FulfillmentChannels**  <br>*optional*|A list that indicates how an order was fulfilled. Filters the results by fulfillment channel. Possible values: FBA (Fulfillment by Amazon); MFN (Fulfilled by the seller).|< string > array|
